...
extern NSString *const RRCONSTANTS_API_KEY_GOOGLE_PLACES;
extern NSString *const RRCONSTANTS_ALERT_TITLE_ERROR;
extern NSString *const RRCONSTANTS_ALERT_TITLE_INFO;
...
extern NSString *const RRCONSTANTS_NO_RATING_TEXT;
extern NSString *const RRCONSTANTS_PIN_GRAPHIC;
extern NSString *const RRCONSTANTS_PIN_CLUSTER_GRAPHIC;
extern NSString *const RRCONSTANTS_PIN_CLUSTER_TITLE;
...
NSString *const RRCONSTANTS_SEARCH_BAR_DEFAULT_TEXT;
