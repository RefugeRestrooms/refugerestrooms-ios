...
const NSString *RRCONSTANTS_APP_NAME = @"Refuge";
...
const NSString *RRCONSTANTS_FILTER_VIEW_CONTROLLER_TITLE = @"Filter Options";
const NSString *RRCONSTANTS_NAVIGATION_BAR_UNISEX_IMAGE_NAME = @"Images/genderqueer-25.png";
const NSString *RRCONSTANTS_NAVIGATION_BAR_ACCESSIBILITY_IMAGE_NAME = @"Images/wheelchair-25.png";
...
const NSString *RRCONSTANTS_SEARCH_BAR_DEFAULT_TEXT = @"Search Address";
